      ...
      <div className=' relative -top-9 md:-top-10'>
        ...
        <form name='miForm' onSubmit={handleSubmit} className='w-full grid place-content-center'>
          ...
          <div className='w-72 md:w-80 mb-4'>
              <input type="checkbox" name="micheckbox" id="miId" value="second_checkbox"/> <label htmlFor="" className='text-sm'>Acepta nuestros</label> <label for="cbox2"><Link to="http://" className='text-blue-700 text-sm'> Términos y condiciones</Link></label>
          </div>
